...
class qa_html_theme extends qa_html_theme_base
{
	...
	public function head_css()
	{
		...
		//adding bootstrap
		$this->content['css_src'][] = $this->rooturl . 'css/bootstrap.min.css';
	...
	public function head_script()
	{
		...
		//$this->content['script'][] = '<script src="' . $this->rooturl . $this->js_dir . '/bootstrap.min.js"></script>';

		$jsUrl = $this->rooturl . $this->js_dir . '/core.js?' . QA_VERSION;
	...
	{
		$this->output(
			'<form method="get" action="/search" class="input-group stylish-input-group">',
                '<input type="text" id="nav-search-field" class="form-control"  placeholder="Search" name="q">',
	...
	function logo()
	{
		$logoUrl = $this->rooturl . $this->image_dir . '/logoprog.png';
		$this->output(
			'<div class="qa-logo">',
	...
	public function nav_main_sub()
	{
		$this->output('<div class="-main">');
			...
			$this->nav('main');
			$this->nav_search();
		$this->output('</div> <!-- END -main -->');
		$this->output('<div class="-actions">');
			$this->nav_user_search();
		$this->output('</div> <!-- END -actions -->');
	}
	...
	public function header()
	{
		...
		$this->output('<header id="qam-topbar" class="fixed">');
			$this->output('<div class="-container">');
				$this->nav_main_sub();
			$this->output('</div <!-- END -container -->');
			if(isset($this->content['navigation']['sub'])){
	...
	public function title()
	{
		...
		if (isset($this->content['title'])) {
			$this->content['title'] = $imgHtml . ($url ? '<a href="' . $url . '">' : '') . $this->content['title'] . ($url ? '</a>' : '');
		}
